<?php
namespace App\Application\Hackthon\GaleriaBundle\Admin;
...
class GaleriaAdmin extends AbstractAdmin
{
    public function toString($object)
    {
        return $object instanceof Galeria
            ? $object->getStringId()
    ...
    protected function configureFormFields(FormMapper $formMapper): void
    {
        $formMapper
            ...
            ->add('imagens', ModelListType::class,[
                    'label' => 'Imagens: ',
                ],[
                    'link_parameters' => [
                            //'context' => 'default',
